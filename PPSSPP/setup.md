...
Launch it one first time, then check in `HOME/.config/PPSSPP/PSP` you should have all the files required, just have to drag and drop the plugin from the **Installation Steps** inside your `PLUGIN` folder.
